...
if ($oResData['state'] == '1') {
    // 정기결제 해지 성공
    // 정기결제 해지는 즉시 실행됩니다.
    // 정기결제 해지는 결제승인 취소가 아닙니다. 해지된 정기결제 요청건은 다음 정기결제 주기에 결제승인 되지 않습니다.

    /*
    TODO : 이곳에서 정기결제 해지 성공 정보를 저장합니다.

    ex) UPDATE rebillrequest SET cancel='y',cancel_date=NOW() WHERE orderno='1234567890'
    */
} else {
    // 정기결제 해지 실패
    ...
    */
    ...
    /*
    TODO : 이곳에서 정기결제 해지 실패 정보를 저장하거나, 이전 페이지로 이동해서 다시 시도할 수 있도록 해야 합니다.
