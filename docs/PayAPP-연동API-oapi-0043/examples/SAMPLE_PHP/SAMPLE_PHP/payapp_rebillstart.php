...
/*                                                                       */
/* oapi sample                                                           */
/* - payapp 서버로 정기결제 승인상태 정보를 전달합니다.                  */
/*                                                                       */
/*************************************************************************/
...
if ($oResData['state'] == '1') {
    // 정기결제 승인 변경 성공
    // 정기결제 승인은 즉시 실행됩니다.
    // 승인된 정기결제 요청건은 다음 정기결제 주기에 결제승인이 발생 합니다.

    /*
    TODO : 이곳에서 정기결제 승인 성공 정보를 저장합니다.

    ex) UPDATE rebillrequest SET start='y',start_date=NOW() WHERE orderno='1234567890'
    */
} else {
    // 정기결제 승인 실패
    ...
    */
    ...
    /*
    TODO : 이곳에서 정기결제 승인 실패 정보를 저장하거나, 이전 페이지로 이동해서 다시 시도할 수 있도록 해야 합니다.
