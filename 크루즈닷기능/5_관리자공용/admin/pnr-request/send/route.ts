...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      console.error(`[PnrRequest] Aligo send error for reservation ${reservationId}:`, sendErr);
    ...
    try {
      ...
      console.error('[PnrRequest] Failed to fetch Aligo remaining balance:', remainError);
    }
    ...
    console.error('[PnrRequest] POST /send error:', error);
    return NextResponse.json(
      {
        ok: false,
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('[PnrRequest] GET error:', error);
    return NextResponse.json(
      {
        ok: false,
