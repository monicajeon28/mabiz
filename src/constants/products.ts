...
export const CRUISE_PRODUCTS = {
  GOLD_A: {
    ...
    pasona: {
      ...
      offer: "원하는 달만 내고, 해지 위약금도 없어서 부담이 전혀 없습니다. 게다가 여행사에 내고 사라지는 돈이 아니라, 회원님 멤버십으로 은행에 안전하게 보관되니 안심하셔도 됩니다",
    },
    topObjections: [
      {
  ...
  GOLD_B: {
    ...
    pasona: {
      ...
      offer: "해지 위약금 없이 원하는 달만 납부. 첫 달 여행 후 아니면 즉시 해지 가능. 내신 돈은 여행사에 사라지는 게 아니라 회원님 멤버십으로 은행에 안전하게 보관되니 믿고 쓰셔도 됩니다",
    },
    topObjections: [
      {
  ...
  GOLD_C: {
    ...
    pasona: {
      ...
      offer: "유럽 5박6일 460만원 → 320만원. 140만원 절약, 한 번에 C플랜 1년치 이상 절감. 매달 내신 돈은 여행사에 사라지는 게 아니라 회원님 멤버십으로 은행에 안전하게 보관됩니다",
    },
    topObjections: [
      {
