...
export async function GET() {
  try {
    ...
    // ── 고객 DB 시트 ──────────────────────────────────────────
    const contactRows = [
      { 이름: "홍길동", 전화번호: "010-1234-5678", 이메일: "hong@example.com", 관심크루즈: "지중해 크루즈", 예산: "100만원대", 메모: "지인 소개", 유형: "잠재고객", 유입날짜: "2025-03-10", 설문1: "크루즈 경험 있음", 설문2: "3인 가족 동반", 설문3: "봄 출발 선호" },
      { 이름: "김영희", 전화번호: "010-9876-5432", 이메일: "",               관심크루즈: "지중해 크루즈", 예산: "200만원대", 메모: "",         유형: "잠재고객", 유입날짜: "2025-04-22", 설문1: "처음 크루즈",   설문2: "부부 2인",     설문3: "" },
      { 이름: "이구매", 전화번호: "010-5555-1234", 이메일: "",               관심크루즈: "카리브해",     예산: "300만원대", 메모: "VIP 고객", 유형: "구매완료",  유입날짜: "2024-11-05", 설문1: "3회 탑승 경험", 설문2: "혼자 여행",    설문3: "여름 선호" },
    ];
    const wsContacts = XLSX.utils.json_to_sheet(contactRows);
    wsContacts["!cols"] = [14, 16, 22, 18, 12, 16, 12, 14, 18, 16, 14].map(w => ({ wch: w }));
