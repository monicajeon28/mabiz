...
import { adminHandler } from '@/lib/webhooks/handlers';
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!signature) {
      logger.warn('[Webhook/Admin] Signature missing');
    ...
    try {
      ...
      logger.warn('[Webhook/Admin] Invalid signature');
    ...
    logger.error('[Webhook/Admin] Error', {
