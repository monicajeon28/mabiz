            ...
            <div className="relative mb-3">
              {selectedContact ? (
                ...
                <>
                  ...
                  {searchingContact && (
                    <p className="text-xs text-gray-400 mt-1 ml-1">검색 중...</p>
                  )}
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {link.contactId && (
                        <span className="shrink-0 px-1.5 py-0.5 bg-blue-100 text-blue-600 text-xs rounded-full flex items-center gap-1">
                    ...
                    <div className="space-y-1.5 max-h-48 overflow-y-auto">
                      {(clickStats[link.id]?.clicks ?? []).map(c => (
                        <div key={c.id} className="flex items-center justify-between text-xs">
                          ...
                          <span className="text-gray-400">{c.contactId ? '등록 고객' : '비회원'}</span>
                        </div>
                      ))}
                    </div>
                  )}
