...
제6조 (DB 지급 및 관리)
① DB 지급 비용: "회사"는 "판매원"에게 영업 DB를 유상으로 제공하며, DB 1건당 지급 비용은 50,000원(5만원)이다.
...
③ DB 소속 및 귀속: 이 계약에 따른 모든 영업 DB는 "회사"에 귀속되며, "판매원"에게 사용 권한만 부여한다. 계약 종료 시 모든 DB 사용 권한은 즉시 소멸한다.

④ DB 유출 금지: "판매원"은 지급받은 DB를 계약 목적 외 용도로 사용하거나 제3자에게 제공·판매·유출하는 일체의 행위를 금한다. 이를 위반하는 경우 DB 1건당 100만 원, 최대 3,000만 원의 손해배상을 "회사"에 배상하여야 한다.
...
① 영업비밀 보호: "판매원"은 계약 기간 중 및 그 이후 1년간 "회사"의 경영전략, 고객 정보, 마케팅 자료, 교육 콘텐츠, DB, 가격 정책, 수수료 구조 등 일체의 영업비밀을 외부에 공개하거나 제3자에게 제공해서는 안 된다.
② 경업 금지: "판매원"은 계약 기간 중 및 계약 종료 후 1년간 "회사"와 동종·유사한 크루즈 여행, 마케팅 교육, B2B 영업 관련 사업을 직접 또는 간접적으로 운영하거나 타 업체에 관련 서비스를 제공하는 행위를 할 수 없다.
③ 스카웃 금지: "판매원"은 계약 기간 중 및 계약 종료 후 1년간 "회사" 소속 판매원, 직원, 제휴 파트너를 대상으로 이탈 유도, 영입, 타 업체 소개 행위를 일체 금지한다.

${isBranch ? `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

제7조의2 (대리점장 파트너십 의무 및 콘텐츠 보호)

[대리점장 파트너십 의무]
① 대리점장은 "회사"와의 독점적 파트너십 관계를 유지하며, 계약 기간 중 경쟁 관계에 있는 타 업체와 유사한 파트너십 계약을 체결할 수 없다. 이를 위반 시 위약금 5,000만 원을 즉시 배상하여야 한다.

② 대리점장은 산하 판매원 관리 및 육성의 총괄 책임을 지며, 산하 판매원이 계약 위반 행위를 할 경우 대리점장도 연대 책임을 부담한다.

③ 대리점장은 "회사"로부터 제공받은 브랜드, 로고, 상호, 마케팅 자료, 교육 콘텐츠를 계약 범위 내에서만 사용하여야 하며, 계약 종료 즉시 모든 사용을 중단하고 관련 자료를 반납 또는 폐기하여야 한다.

[콘텐츠 보호 조항 — 위반 시 중대 제재]
④ 저작권 보호: "회사"가 제작한 모든 교육 콘텐츠, 영상, 마케팅 자료, AI 시스템, 판매몰 디자인은 "회사"의 저작물로 보호된다. 대리점장은 이를 무단 복제, 배포, 수정, 재판매하는 일체의 행위를 금한다.
...
⑥ 독립 사업 전용 금지: 대리점장은 "회사"의 시스템, 브랜드, 고객 DB를 활용하여 "회사"를 배제하고 독립 사업을 전개할 수 없다.
    위반 시: 즉시 계약 해지 + 위약금 5,000만 원 + 발생 매출 전액 반환

[위약벌 — 대리점장 전용]
⑦ 다음 각 호의 경우 해당 위약금이 부과된다:
    · 경업금지 위반: 위약금 5,000만 원 + 경업으로 발생한 매출의 30%
    · 산하 판매원 타사 유인·스카웃: 유인한 판매원 1인당 1,000만 원
...
⑨ 분쟁 발생 시 "회사"는 즉시 가처분 신청, 영업정지 가처분, 손해배상 청구소송을 동시에 진행할 수 있으며, 대리점장은 이를 이의 없이 수용한다.` : ''}
...
(갑) 회사명 : ${COMPANY.name}
  ...
  // 대리점 계약서는 "판매원" → "대리점(장)" 으로 교체
  // (제7조의2 등 이미 대리점장 표현이 있는 부분 제외, 기본 조문 전체 교체)
  if (isBranch) {
    return body
      .replace(/크루즈닷기능\(이하 "회사"\), 판매원\(이하 "판매원"\)/g,
        '크루즈닷기능(이하 "회사"), 대리점(이하 "대리점")')
      .replace(/"판매원"\(이하 "판매원"\)/g, '"대리점"(이하 "대리점")')
      .replace(/본 계약의 "판매원"은/g, '본 계약의 "대리점"은')
      .replace(/판매원 자체 판매, 의뢰 및 기타 서비스 활동을 독자적으로 수행하기로 한다\. 제공되는 서비스에는 DB 영업, 크루즈 소개, 판매원 관련 활동 등이 포함된다\./g,
        '대리점 자체 영업, 산하 판매원 관리 및 기타 서비스 활동을 독자적으로 수행하기로 한다. 제공되는 서비스에는 DB 영업, 크루즈 여행 소개, 판매원 육성 및 파트너십 활동 등이 포함된다.')
      .replace(/"회사", "판매원" 및 "고객"이 활용하는/g, '"회사", "대리점" 및 "고객"이 활용하는')
      .replace(/"판매원"이 자체 고객자를/g, '"대리점"이 자체 고객자를')
      .replace(/이 계약에 따라 "고객"이 소유한다\./g, '이 계약에 따라 "회사"가 소유하며 "대리점"에게 이용 권한을 부여한다.')
      .replace(/"회사", "판매원" 및 "고객"이 활용하는 "마케팅서비스"를 이용하는 제반 활동을 의미한다\./g,
        '"회사", "대리점" 및 "고객"이 활용하는 "마케팅서비스"를 이용하는 제반 활동을 의미한다.')
      .replace(/대리점장으로서 산하 판매원 관리 및 영업 총괄 활동을 수행한다\./g,
        '대리점장으로서 산하 판매원 관리, 영업 총괄 및 파트너십 유지 활동을 수행한다.')
      .replace(/"회사"와 "판매원"의 계약에/g, '"회사"와 "대리점"의 계약에')
      .replace(/"판매원"은 계약 체결 후/g, '"대리점"은 계약 체결 후')
      // 일반적인 "판매원" 남은 것들 교체 (대리점장 조항 내부 제외)
      .replace(/(?<![산하 ])"판매원"(?![ ]관리|[ ]육성|[ ]1인당|을 영입)/g, '"대리점"');
  }
  return body;
}
